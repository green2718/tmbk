...
<body>
   <h1>Bienvenue sur <strong class="title">The Most Beautiful Kitten</strong></h1>
   <p>
  ...
  <p>
    Pour cela, votre aide est nécessaire&nbsp;: il faudra cliquer sur le <strong>chaton</strong> le plus mignon des deux. Petit à petit, nous pourrons déterminer lequel est le plus mignon.<br/>
